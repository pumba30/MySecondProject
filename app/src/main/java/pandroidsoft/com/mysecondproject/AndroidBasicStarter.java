...
/**
 * Created by pumba30 on 10.02.2015.
 */
...
public class AndroidBasicStarter extends ListActivity {
    String tests[] = {"LifeCycleTest", "SingleTouchTest", "MultiTouchTest", "KeyTest",
            "AccelerometrTest", "AssetsTest", " ExternalStorageTest", "SoundPoolTest",
    ...
    protected void onListItemClick(ListView list, View view, int position,
        ...
        try {
            Class clazz = Class.forName("pandroidsoft.com.mysecondproject." + testName);
